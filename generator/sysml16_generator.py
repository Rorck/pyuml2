...
def generate_code():
    ...
    sysml_root = rset.get_resource('sysml-resources/SysML.profile.ecore').contents[0]
    generator = EcoreGenerator(user_module='pysysml16.sysml16_mixins')
    for task in generator.tasks:
        task.formatter = format_autopep8
    generator.generate(sysml_root, 'pysysml16')
